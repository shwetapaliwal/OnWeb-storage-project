<%-- 
    Document   : new_folder
    Created on : Mar 13, 2016, 4:09:36 PM
    Author     : shweta
--%>
...
//            out.print(name);
            ...
            <button id="btn">Click here to Upload <img src="images/arrow1.png"></button> <br/><br/><br/>
             <div id="window">
                <form method="post" action="main_folder" enctype="multipart/form-data">
                <center>
                <table  width="95%" cellpadding="8" >
                    <thead> 
                    <th colspan="6" id="tab">Upload File</th>        
                    </thead>
                    <tbody>
                        <tr>    
                            <td id="tab1">Title : </td>
                            <td><input type="text" name="title" id="tab2" required=""></td>
                        </tr>
                        <tr>
                            <td id="tab1">Choose File : </td>
                            <td><input type="file" name="file_uploaded" id="tab2" required=""/></td>
                        </tr>
           ...
           <div>
            ...
            <tbody id="tbody">
                ...
                %>
                        ...
                        <acronym title="View File"> <a href="folder_viewfile.jsp?id=<%out.print(rs.getString("id"));%>"><img src="images/view.png"></a></acronym>&nbsp;
                        <acronym title="Download File"><a href="folder_download.jsp?id=<%out.print(rs.getString("id"));%>"><img src="images/download.png"></a></acronym>&nbsp;
                        <acronym title="Delete File"><a href="folder_delete?id=<%out.print(rs.getString("id"));%>"><img src="images/delete.png"></a></acronym>
                            </td>
